...
public class SampleSarvlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        pw.println("<head><title>PostgreSQL 9.2_JavaServlet TEST</title></head>");
        pw.println("<HTML><BODY>"
        		+ "●PostgreSQL 9.2接続テスト(JavaServlet)<TABLE border=1>");
        ...
        try {
          ...
          ResultSet res = db.ExeQuery("select * from m01tokuisaki order by tokuisaki_cd");
            ...
            while (res.next()){
                ...
                pw.println("<TD>" + ((res.getString(10) != null && !res.getString(10) .isEmpty())?res.getString(10):"&nbsp;")+ "</TD>");
                pw.println("<TD>" + ((res.getString(11) != null && !res.getString(11) .isEmpty())?res.getString(11):"&nbsp;")+ "</TD>");
                pw.println("</TR>");
            }
